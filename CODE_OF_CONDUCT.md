...
We as members, contributors, and leaders pledge to make participation in the RepoDNA
...
RepoDNA analyzes the work of real people. When discussing contributor statistics or
analyses of other projects, talk about the code and the data, never about the worth of the
people behind them.
...
community leaders responsible for enforcement, listed in [MAINTAINERS.md](MAINTAINERS.md).
To report privately, use the contact details on the maintainer's GitHub profile
([github.com/sanskarIN](https://github.com/sanskarIN)), or open a private report through
[GitHub's private reporting form](https://github.com/sanskarIN/RepoDNA/security/advisories/new)
and say that it concerns the Code of Conduct. All complaints will be reviewed and
...
<https://www.contributor-covenant.org/version/2/1/code_of_conduct.html>, and is licensed
